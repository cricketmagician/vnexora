  ...
  return (
    ...
    >
      <Link href="/say-hello" className="relative block">
        ...
        <div className="relative flex items-center gap-5 px-10 py-6 bg-[#8B0000] hover:bg-[#a50000] text-white border border-white/10 hover:border-white/20 rounded-full transition-all duration-700 shadow-2xl backdrop-blur-3xl overflow-hidden">
           {/* Scanline Effect */}
