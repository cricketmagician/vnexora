...
const slides = [
  ...
  },
  {
    ...
    description: "To check your hotel score <span class='text-[#D4AF37] font-bold'>click here</span> and discover massive revenue potential with our institutional diagnostic tool.",
    ctaText: "CLICK HERE"
  },
  {
    id: 3,
              ...
              >
                {slide.ctaText === "CLICK HERE" ? (
                  <a href="https://skill-deploy-zt6s8l6jd1.vercel.app" target="_blank" rel="noopener noreferrer">
                    <Button 
                      size="lg" 
                      className="px-16 py-8 bg-[#D4AF37] text-black border border-[#D4AF37] hover:bg-white hover:text-[#D4AF37] hover:border-white font-black tracking-[0.5em] uppercase transition-all duration-700 backdrop-blur-3xl group shadow-[0_40px_80px_rgba(0,0,0,0.5)] relative overflow-hidden"
                    >
