...
const slides = [
  ...
  },
  {
    ...
    description: "To check your hotel score <span class='text-[#E3B448] font-bold'>click here</span> and discover massive revenue potential with our institutional diagnostic tool.",
    ctaText: "CLICK HERE"
  },
  {
    id: 3,
    ...
    <section className="relative z-0 h-screen w-full overflow-hidden bg-black flex items-center justify-center">
              ...
              >
                {slide.ctaText === "CLICK HERE" ? (
                  <a href="https://skill-deploy-zt6s8l6jd1.vercel.app" target="_blank" rel="noopener noreferrer">
                    <Button 
                      size="lg" 
                      className="px-16 py-8 bg-[#E3B448] text-black border border-[#E3B448] hover:bg-white hover:text-[#E3B448] hover:border-white font-black tracking-[0.5em] uppercase transition-all duration-700 backdrop-blur-3xl group shadow-[0_40px_80px_rgba(0,0,0,0.5)] relative overflow-hidden"
                    >
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 -inset-x-10 z-0" />
        </Link>
      </motion.div>
    </section>
  );
