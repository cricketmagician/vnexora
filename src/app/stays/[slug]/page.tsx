...
export default function PropertyDetailPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FAF9F6] text-[#020617]">
      {/* ── TOP NAV ── */}
      <nav className="fixed top-0 inset-x-0 z-50 px-6 py-4 flex items-center justify-between pointer-events-none">
        <Link 
          href="/stays" 
          className="pointer-events-auto flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-md rounded-full border border-black/5 shadow-sm text-[10px] font-black uppercase tracking-widest hover:bg-[#020617] hover:text-white transition-all"
        >
          <ArrowLeft size={14} />
          Back to Collection
        </Link>
