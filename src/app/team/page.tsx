  ...
  return (
    ...
    >
      ...
      >
        {/* Image - Full Color */}
        <div 
          className={`absolute inset-0 bg-cover transition-transform duration-700 ease-out ${(member.name === 'Kesar' || member.name === 'Ambalica') ? 'bg-[center_40%] scale-[1.25] group-hover:scale-[1.35]' : (member.name === 'Gitanjali' || member.name === 'Monika Sharma') ? 'bg-[center_30%] scale-[1.15] group-hover:scale-[1.25]' : 'bg-[center_15%] group-hover:scale-110'}`}
