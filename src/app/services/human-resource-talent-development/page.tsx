    ...
    <main className="min-h-screen bg-[#FAF9F6]">
      ...
      <div className="bg-[#050505] pt-32 pb-16 md:pt-40 md:pb-24 text-center">
        <div className="container mx-auto px-4">
          ...
          >
            Human Resource & Talent for <br />
            <span className="font-bold uppercase tracking-tight">Luxury Excellence</span>
          </motion.h1>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            ...
            <div className="absolute bottom-10 left-10 text-white/90">
              <p className="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] uppercase">Vnexora Talent Management, Global Recruitment</p>
            </div>
          </motion.div>
        </div>
      </Section>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          ...
          >
            <p className="text-xl md:text-3xl text-zinc-800 font-sans font-light leading-relaxed tracking-tight">
              Hospitality is a people business. At Vnexora, we specialize in high-fidelity recruitment, training, and talent development that align with the world's most prestigious luxury standards. Our human capital strategies ensure your property is staffed by the elite.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
            <motion.div
               ...
               className="space-y-8"
            >
              <h3 className="text-zinc-400 font-sans font-bold text-[10px] tracking-[0.4em] uppercase mb-4">Talent Acquisition</h3>
              <ul className="space-y-6">
                {[
                  "Executive & Leadership Recruitment",
                  "Cross-Border Talent Sourcing",
                  "Cultural & Brand Fit Assessment",
                  "Pre-Opening Staffing & Logistics"
                ].map((feature, index) => (
            ...
            <motion.div
               ...
               className="space-y-8"
            >
              <h3 className="text-zinc-400 font-sans font-bold text-[10px] tracking-[0.4em] uppercase mb-4">Development & Culture</h3>
              <ul className="space-y-6">
                {[
                  "Luxury Service Standards Training",
                  "Operational SOP Implementation",
                  "Leadership Growth & Mentorship",
                  "Performance KPI Construction"
                ].map((feature, index) => (
                  <li key={index} className="flex items-start text-zinc-700">
                    <CheckCircle2 className="w-5 h-5 text-[#CFA052] mr-4 shrink-0 mt-0.5" />
                    <span className="leading-snug font-sans font-light text-lg">{feature}</span>
