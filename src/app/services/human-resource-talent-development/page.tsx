...
export default function HRTalentHub() {
  ...
  // Journey Scroll Setup
  const { scrollYProgress: journeyProgress } = useScroll({
    target: journeyRef,
    offset: ["start end", "end start"]
  });

  const xTranslate = useTransform(journeyProgress, [0.3, 0.6], ["0%", "-50%"]);
  ...
  return (
    <main ref={containerRef} className="bg-[#050505] text-white selection:bg-[#CFA052] selection:text-black font-sans overflow-x-hidden">
      ...
      <section className="relative h-[110vh] overflow-hidden flex items-center justify-center">
        ...
        >
          <Image 
            src="/images/services/hospitality_staff_dashboard_modern_operations.png" 
            alt="HR Hero" 
            fill 
          ...
          <div className="flex flex-col items-center text-center">
            ...
            >
              ...
              <p className="max-w-2xl mx-auto text-xl md:text-2xl font-light text-white/50 leading-relaxed italic border-l border-[#CFA052]/30 pl-10 text-left">
                "We don't just hire staff; we cultivate the human capital that defines elite hospitality service standards."
              </p>
            </motion.div>
            ...
            >
              <span className="text-[10px] font-black tracking-[0.6em] uppercase text-[#CFA052]/60">Cultural Immersion</span>
      ...
      {/* 2. THE HUMAN CAPITAL BLUEPRINT — Institutional Split Narrative */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            ...
            >
              <div className="flex items-center gap-4">
                 ...
                 <span className="text-[10px] font-black text-[#CFA052] tracking-[0.6em] uppercase block">Operational Alpha</span>
              </div>
              <h2 className="text-5xl md:text-8xl font-serif italic leading-[0.95] text-stone-900">
                Service <br />
                <span className="not-italic font-black text-stone-200 uppercase tracking-tighter">Excellence.</span>
              </h2>
              <p className="text-2xl text-stone-500 font-light leading-relaxed max-w-xl italic">
                Our HR advisory ensures hospitality assets are powered by trained professionals who understand the nuances of discreet luxury and operational rigor.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 pt-20 border-t border-stone-200">
                <div className="space-y-6">
                  <div className="w-14 h-14 bg-stone-50 border border-stone-200 flex items-center justify-center rotate-3 hover:rotate-0 transition-transform">
                    <Users size={20} className="text-[#CFA052]" />
                  </div>
                  <h4 className="text-sm font-bold tracking-widest uppercase text-stone-900">Elite Acquisition</h4>
                  <p className="text-stone-400 font-light text-base leading-relaxed">Targeted recruitment of Tier-1 hospitality talent from global aviation and luxury hotel hubs.</p>
                </div>
                <div className="space-y-6">
                  <div className="w-14 h-14 bg-stone-50 border border-stone-200 flex items-center justify-center -rotate-3 hover:rotate-0 transition-transform">
                    <Award size={20} className="text-[#CFA052]" />
                  </div>
                  <h4 className="text-sm font-bold tracking-widest uppercase text-stone-900">Culture Induction</h4>
                  <p className="text-stone-400 font-light text-base leading-relaxed">Proprietary training modules focused on emotional intelligence and soft-skill precision.</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-12 left-12">
                 <div className="px-8 py-3 bg-white/10 backdrop-blur-2xl border border-white/20 rounded-full flex items-center gap-4">
                    ...
                    <span className="text-[10px] font-black tracking-[0.4em] uppercase text-white">Talent Node_HR9</span>
                 </div>
              </div>
            </motion.div>
          </div>
      ...
      {/* 3. THE HUMAN CAPITAL JOURNEY — Horizontal Scroll */}
      <section ref={journeyRef} className="h-[250vh] bg-[#050505] relative pt-32">
        <div className="sticky top-0 h-screen overflow-hidden flex flex-col justify-center">
          <div className="container mx-auto px-6 mb-20 pointer-events-none z-20">
             <motion.h2 
               style={{ opacity: useTransform(journeyProgress, [0.3, 0.45], [0, 1]) }}
          ...
          >
            {[
              { title: "Strategic Sourcing", category: "Acquisition", icon: Globe, img: "/images/hero/hero_checkin.png" },
              { title: "Behavioral Mapping", category: "Profiling", icon: Gem, img: "/images/services/luxury_hotel_interior_hero.png" },
              { title: "Pre-Opening Induction", category: "Training", icon: Zap, img: "/images/services/luxury_marble_textures_moodboard.png" },
              { title: "Continuous Ops Audit", category: "Excellence", icon: ShieldCheck, img: "/images/services/hospitality_staff_dashboard_modern_operations.png" },
              { title: "Leadership Pipeline", category: "Legacy", icon: Award, img: "/images/services/luxury_hotel_service_excellence_horizontal.png" }
            ].map((item, i) => (
              <motion.div 
                key={i}
              ...
              >
                ...
                <div className="absolute top-12 right-12 w-16 h-16 bg-white/5 backdrop-blur-[30px] rounded-full border border-white/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-700 transform translate-y-6 group-hover:translate-y-0">
                  <item.icon size={28} className="text-[#CFA052]" />
                </div>
              </motion.div>
            ))}
          </motion.div>
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-32 items-center">
            ...
            <div className="lg:w-1/2 space-y-16">
               ...
               <p className="text-2xl text-stone-400 font-light leading-relaxed max-w-sm italic">
                  Initiate a talent advisory mandate or full-scale recruitment outsourcing.
               </p>
               
               <div className="flex flex-col gap-8 pt-12 border-t border-stone-200">
                 {[
                   "Tier-1 Specialist Recruitment",
                   "Pre-Opening HR Strategy & Setup",
              ...
              {!isSubmitted ? (
                ...
                >
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center gap-4 mb-16">
                         <Briefcase size={20} className="text-[#CFA052]" />
                         <h3 className="text-2xl md:text-3xl font-serif italic">HR Intake Portal</h3>
                      </div>
                      ...
                      <form className="space-y-12" onSubmit={(e) => { e.preventDefault(); setIsSubmitted(true); }}>
                         <div className="group border-b border-white/10 focus-within:border-[#CFA052] transition-colors duration-500">
                            <label className="block text-[9px] font-black uppercase tracking-[0.5em] text-white/40 mb-4 ml-1 group-focus-within:text-[#CFA052] transition-colors italic">Corporate Identity</label>
                            <input required type="text" className="w-full bg-transparent p-4 text-xl font-light focus:outline-none placeholder:text-white/10 uppercase tracking-tighter" placeholder="BRAND / OWNERSHIP GROUP" />
                         </div>
                         
                         <div className="grid grid-cols-2 gap-12">
                            <div className="group border-b border-white/10 focus-within:border-[#CFA052] transition-colors duration-500">
                               <label className="block text-[9px] font-black uppercase tracking-[0.5em] text-white/40 mb-4 ml-1 group-focus-within:text-[#CFA052] transition-colors">Service Scope</label>
                               <select className="w-full bg-transparent p-4 text-sm font-bold uppercase tracking-widest focus:outline-none appearance-none cursor-pointer">
                                  <option className="bg-[#050505]">Executive Recruitment</option>
                                  <option className="bg-[#050505]">Pre-Opening Setup</option>
                                  <option className="bg-[#050505]">Ongoing HR Outsourcing</option>
                                  <option className="bg-[#050505]">Training & Induction</option>
                               </select>
                            </div>
                            <div className="group border-b border-white/10 focus-within:border-[#CFA052] transition-colors duration-500">
                               <label className="block text-[9px] font-black uppercase tracking-[0.5em] text-white/40 mb-4 ml-1 group-focus-within:text-[#CFA052] transition-colors">Talent Volume</label>
                               <input type="text" className="w-full bg-transparent p-4 text-sm font-bold uppercase tracking-widest focus:outline-none placeholder:text-white/10" placeholder="10 - 500+ STAFF" />
                            </div>
                         </div>

                         <div className="group border-b border-white/10 focus-within:border-[#CFA052] transition-colors duration-500">
                            <label className="block text-[9px] font-black uppercase tracking-[0.5em] text-white/40 mb-4 ml-1 group-focus-within:text-[#CFA052] transition-colors italic">Mandate Details (e.g. GM Recruitment, Resort Opening)</label>
                            <textarea className="w-full bg-transparent p-4 text-base font-light focus:outline-none placeholder:text-white/10 h-32 resize-none uppercase" placeholder="DESCRIBE YOUR HUMAN CAPITAL CHALLENGES..." />
                          </div>
                ...
                >
                   ...
                   <p className="text-white/40 text-lg font-light leading-relaxed mb-12 italic">
                      A senior HR advisor will initiate contact through private channels within 24 hours.
                   </p>
      ...
      <footer className="py-24 border-t border-white/5 text-center px-6">
         <Link href="/services/finance-accounting" className="text-4xl md:text-[10vw] font-serif italic text-white/5 hover:text-[#CFA052]/40 transition-[color] uppercase tracking-tighter duration-1000">
            Next: Finance Mandate
         </Link>
      </footer>
    </main>
  );
