    ...
    <main className="relative min-h-screen bg-[#FAF9F6] text-[#1A1A1A] overflow-x-hidden selection:bg-[#A67C52] selection:text-white font-sans">
      ...
      <section className="relative h-screen min-h-[700px] flex items-center overflow-hidden bg-[#0A0A0A]">
        <div className="absolute inset-0">
          <Image
            src="/images/services/hero_dark.png"
            alt="Vnexora Services Dark"
            fill
            priority
        ...
        <motion.div
          ...
          className="absolute top-[110px] left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#A67C52]/40 to-transparent origin-left z-10"
        />

        <div className="relative z-10 px-8 md:px-20 lg:px-28 max-w-[1600px] mx-auto w-full">
          <motion.div
          ...
          >
            ...
            <span className="text-[9px] font-bold uppercase tracking-[0.5em] text-[#A67C52]">What We Do</span>
          </motion.div>

          <div className="flex flex-col gap-0 mb-12">
            {["End-to-End", "Hotel", "Management."].map((word, i) => (
              <div key={word} className="overflow-hidden">
                <motion.h1
                  ...
                  className={`font-serif font-light leading-none tracking-tight ${
                    i === 2
                      ? "text-5xl md:text-8xl lg:text-[7.5rem] text-[#A67C52] italic"
                      : "text-5xl md:text-8xl lg:text-[7.5rem] text-white"
                  }`}
                >
                  {word}
                </motion.h1>
          ...
          <motion.div
            ...
            className="w-20 h-[1px] bg-[#A67C52]/50 mb-10 origin-left"
          />
        ...
        >
          <div className="w-[1px] h-12 bg-gradient-to-b from-[#A67C52]/60 to-transparent animate-pulse" />
        </motion.div>
      </section>
