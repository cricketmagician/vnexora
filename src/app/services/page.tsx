              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {(activeTab === 'pre' ? [
                    ...
                    { title: "Operations Management", desc: "Providing end-to-end operational leadership, ensuring smooth daily functioning and consistent service.", icon: <Settings className="w-5 h-5" />, image: "/images/services/lifecycle/card-1.jpg" },
                    { title: "Staff Training & Development", desc: "Delivering continuous training programs to enhance skills, maintain excellence, and elevate experience.", icon: <Activity className="w-5 h-5" />, image: "/images/services/lifecycle/card-2.jpg" },
                    { title: "SOPs & Operational Manuals", desc: "Developing comprehensive manuals to ensure consistency, efficiency, and scalable systems.", icon: <FileText className="w-5 h-5" />, image: "/images/services/lifecycle/card-3.jpg" },
                    { title: "Operational Audits", desc: "Conducting detailed audits to identify inefficiencies, benchmark performance, and implement strategies.", icon: <Microscope className="w-5 h-5" />, image: "/images/services/lifecycle/card-4.jpg" },
                    { title: "Cost Control & Optimization", desc: "Implementing structured financial controls, monitoring expenses, and improving margins.", icon: <Coins className="w-5 h-5" />, image: "/images/services/lifecycle/card-5.jpg" },
                    { title: "Revenue Management", desc: "Driving growth through pricing strategies, demand forecasting, and direct booking enhancement.", icon: <BarChart3 className="w-5 h-5" />, image: "/images/services/lifecycle/card-6.jpg" },
                    { title: "Brand Collaboration & Expansion", desc: "Facilitating brand partnerships and expansion strategies to scale the business across new markets.", icon: <Globe className="w-5 h-5" />, image: "/images/services/lifecycle/card-7.jpg" },
                    { title: "Guest Experience & QA", desc: "Enhancing guest satisfaction through monitoring and feedback systems to build strong brand loyalty.", icon: <Heart className="w-5 h-5" />, image: "/images/services/lifecycle/card-8.jpg" }
                  ]).map((service, i) => (
                    <div 
                      key={i} 
