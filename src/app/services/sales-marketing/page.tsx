    ...
    <main className="min-h-screen bg-[#FAF9F6]">
      ...
      <div className="bg-[#050505] pt-32 pb-16 md:pt-40 md:pb-24 text-center">
        <div className="container mx-auto px-4">
          ...
          >
            Sales, Marketing & Revenue for <br />
            <span className="font-bold uppercase tracking-tight">Growth & Visibility</span>
          </motion.h1>
        </div>
      </div>
      ...
      <Section spacing="none" className="bg-[#050505] pb-20 overflow-visible">
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            <Image 
              src="/Users/nihalkumar/.gemini/antigravity/brain/d8eb8cb0-780e-4ed2-9658-3d7040cb22ea/sales_marketing_luxury_analytics_1775369418612.png"
              alt="Sales, Marketing & Revenue Optimization"
              fill
            ...
            <div className="absolute bottom-10 left-10 text-white/90">
              <p className="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] uppercase">Vnexora Revenue Management, Sales Office</p>
            </div>
          </motion.div>
        </div>
      </Section>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          ...
          >
            <p className="text-xl md:text-3xl text-zinc-800 font-sans font-light leading-relaxed tracking-tight">
              Effective positioning and promotion are crucial in today's competitive hospitality space. Vnexora builds sales strategies that blend local intelligence with global outreach to drive direct bookings and boost property visibility.
            </p>
          </motion.div>

          {/* Revenue Strategies Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
            <motion.div
               ...
               className="space-y-8"
            >
              <h3 className="text-zinc-400 font-sans font-bold text-[10px] tracking-[0.4em] uppercase mb-4">Sales & Distribution</h3>
              <ul className="space-y-6">
                {[
                  "Digital Marketing & CRM Integration",
                  "Revenue & Yield Optimization",
                  "Direct Booking & OTA Strategy",
                  "Corporate & B2B Sales Network"
                ].map((feature, index) => (
            ...
            <motion.div
               ...
               className="space-y-8"
            >
              <h3 className="text-zinc-400 font-sans font-bold text-[10px] tracking-[0.4em] uppercase mb-4">Marketing & Presence</h3>
              <ul className="space-y-6">
                {[
                  "Web Design, SEO & Content Strategy",
                  "PR, Media & Influencer Collabs",
                  "Graphic Design & Visual Storytelling",
                  "Online Reputation & Social Management"
                ].map((feature, index) => (
                  <li key={index} className="flex items-start text-zinc-700">
                    <CheckCircle2 className="w-5 h-5 text-[#CFA052] mr-4 shrink-0 mt-0.5" />
                    <span className="leading-snug font-sans font-light text-lg">{feature}</span>
