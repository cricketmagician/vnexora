          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-8 max-w-5xl mx-auto">
            {serviceNavItems.map((item, i) => (
              <button
                ...
                className="group flex flex-col items-center gap-3 w-[120px] md:w-[140px]"
              >
                <div className="relative w-[120px] h-[80px] md:w-[140px] md:h-[95px] overflow-hidden rounded-sm shadow-md group-hover:shadow-xl transition-shadow">
